...
import AetherCodec=aetherCore.AetherCodec;
import CryptoLib=aetherCore.CryptoLib;
...
import UUID=aetherCore.UUID;
import SC=aetherTrans.transport.SC;
import SCD=aetherTrans.transport.SCD;
import ApiNode=aetherCore.ApiNode;
import CryptoNode=aetherCore.CryptoNode;
...
import makeSList=Meta.makeSList;
...
import MAetherCodec=aetherCore.MAetherCodec;
import MCryptoLib=aetherCore.MCryptoLib;
import MBoolean=Meta.MBoolean;
import MDate=Meta.MDate;
import MInt8=Meta.MInt8;
import MInt16=Meta.MInt16;
import MInt32=Meta.MInt32;
import MInt64=Meta.MInt64;
import MUUID=aetherCore.MUUID;
import MFuture=Meta.MFuture;
import MString=Meta.MString;
import MUint8Array=Meta.MUint8Array;
import MUint16Array=Meta.MUint16Array;
import MUint32Array=Meta.MUint32Array;
import MUint64Array=Meta.MUint64Array;
...
export let CoderAndPort_META=makeObj<CoderAndPort>({f:[{n:"codec",t:MAetherCodec},{n:"port",t:MInt16}]});

export class IPAddressAndPorts{
address:IPAddress;
coderAndPorts:Array<CoderAndPort>;
}
export let IPAddressAndPorts_META=makeObj<IPAddressAndPorts>({f:[{n:"address",t:IPAddress_META},{n:"coderAndPorts",t:makeList<CoderAndPort>(CoderAndPort_META)}]});

export class IPAddressAndPortsList{
addresses:Array<IPAddressAndPorts>;
}
export let IPAddressAndPortsList_META=makeObj<IPAddressAndPortsList>({f:[{n:"addresses",t:makeList<IPAddressAndPorts>(IPAddressAndPorts_META)}]});

export class ServerDescriptor{
id:Int16;
ipAddress:IPAddressAndPortsList;
}
export let ServerDescriptor_META=makeObj<ServerDescriptor>({f:[{n:"id",t:MInt16},{n:"ipAddress",t:IPAddressAndPortsList_META}]});
...
export let AccessGroup_META=makeObj<AccessGroup>({f:[{n:"id",t:MInt64},{n:"data",t:makeSet<UUID>(MUUID)},{n:"owner",t:MUUID}]});
...
export let RegistrationRootApi_META=makeApi<RegistrationRootApi>([{n:"getAsymmetricPublicKey",id:3,a:[{n:"cryptoLib",t:MCryptoLib}],r:makeRFuture<crypt.SignedKey>(crypt.SignedKey_META)},{n:"enter",id:4,a:[{n:"cryptoLib",t:MCryptoLib},{n:"st",t:makeValue<Uint8Array>(MUint8Array)}]}]);}
}
...
export let ServerApiByUid_META=makeApi<ServerApiByUid>([{n:"onlineTime",id:20,a:[],r:makeRFuture<Date>(MDate)},{n:"getBalance",id:3,a:[],r:makeRFuture<Int64>(MInt64)},{n:"getBeneficiary",id:15,a:[],r:makeRFuture<UUID>(MUUID)},{n:"setBeneficiary",id:16,a:[{n:"uid",t:MUUID}],r:MFuture},{n:"getBlockTime",id:17,a:[],r:makeRFuture<Date>(MDate)},{n:"addAccessGroup",id:21,a:[{n:"groupId",t:MInt64}],r:makeRFuture<boolean>(MBoolean)},{n:"removeAccessGroup",id:22,a:[{n:"groupId",t:MInt64}],r:makeRFuture<boolean>(MBoolean)},{n:"unblock",id:18,a:[],r:MFuture},{n:"getParent",id:14,a:[],r:makeRFuture<UUID>(MUUID)},{n:"block",id:6,a:[],r:MFuture},{n:"setParent",id:4,a:[{n:"uid",t:MUUID}],r:MFuture},{n:"createTime",id:19,a:[],r:makeRFuture<Date>(MDate)},{n:"getPosition",id:7,a:[],r:makeRFuture<common.Cloud>(common.Cloud_META)}]);
...
export let AuthorizedApi_META=makeApi<AuthorizedApi>([{n:"backId",id:5,a:[{n:"id",t:MInt8}]},{n:"ping",id:6,a:[{n:"nextConnectMsDuration",t:MInt64}],r:MFuture},{n:"createAccessGroup",id:13,a:[{n:"owner",t:MUUID},{n:"uids",t:makeList<UUID>(MUUID)}],r:makeRFuture<Int64>(MInt64)},{n:"addToAccessGroup",id:14,a:[{n:"groupId",t:MInt64},{n:"uid",t:MUUID}],r:makeRFuture<boolean>(MBoolean)},{n:"removeFromAccessGroup",id:15,a:[{n:"groupId",t:MInt64},{n:"uid",t:MUUID}],r:makeRFuture<boolean>(MBoolean)},{n:"checkAccessForSendMessage",id:16,a:[{n:"uid",t:MUUID}],r:MFuture},{n:"resolverServers",id:17,a:[{n:"sid",t:makeValue<Uint16Array>(MUint16Array)}]},{n:"resolverClouds",id:18,a:[{n:"uids",t:makeValue<Array<UUID>>(makeList<UUID>(MUUID))}]},{n:"getAccessGroups",id:19,a:[{n:"uid",t:MUUID}],r:makeRFuture<Set<Int64>>(makeSet<Int64>(MInt64))},{n:"getAccessGroup",id:20,a:[{n:"groupId",t:MInt64}],r:makeRFuture<common.AccessGroup>(common.AccessGroup_META)},{n:"getAllAccessedClients",id:21,a:[{n:"uid",t:MUUID}],r:makeRFuture<Set<UUID>>(makeSet<UUID>(MUUID))},{n:"checkAccessForSendMessage2",id:22,a:[{n:"uid1",t:MUUID},{n:"uid2",t:MUUID}],r:makeRFuture<boolean>(MBoolean)},{n:"clientSelf",id:8,a:[],r:makeRFuture<SC<Gate<ServerApiByUidClient,ServerApiByUid>>>(makeSC<Gate<ServerApiByUidClient,ServerApiByUid>>())},{n:"sendMessage",id:10,a:[{n:"uid",t:MUUID},{n:"data",t:makeValue<Uint8Array>(MUint8Array)}]},{n:"resolvers",id:12,a:[{n:"servers",t:makeSC<Gate<Int16,common.ServerDescriptor>>()},{n:"clouds",t:makeSC<Gate<UUID,common.UUIDAndCloud>>()}]},{n:"client",id:7,a:[{n:"uid",t:MUUID}],r:makeRFuture<SC<Gate<ServerApiByUidClient,ServerApiByUid>>>(makeSC<Gate<ServerApiByUidClient,ServerApiByUid>>())}]);
...
export let LoginApi_META=makeApi<LoginApi>([{n:"loginByUID",id:3,a:[{n:"st",t:makeSC<ApiNode<clientApi.ClientApiSafe,AuthorizedApi,CryptoNode>>()},{n:"uid",t:MUUID}]},{n:"getTimeUTC",id:5,a:[],r:makeRFuture<Int64>(MInt64)},{n:"loginByUID2",id:6,a:[{n:"uid",t:MUUID},{n:"data",t:makeSCD<ApiNode<clientApi.ClientApiSafe,AuthorizedApi,CryptoNode>>()}]},{n:"loginByAlias2",id:7,a:[{n:"alias",t:MUUID},{n:"data",t:makeSCD<ApiNode<clientApi.ClientApiSafe,AuthorizedApi,CryptoNode>>()}]},{n:"loginByAlias",id:4,a:[{n:"st",t:makeSC<ApiNode<clientApi.ClientApiSafe,AuthorizedApi,CryptoNode>>()},{n:"alias",t:MUUID}]}]);}
...
export let ClientApiUnsafe_META=makeApi<ClientApiUnsafe>([{n:"sendSafeApiDataMulti",id:6,a:[{n:"backId",t:MInt8},{n:"data",t:makeValue<Uint8Array>(MUint8Array)}]},{n:"sendSafeApiData",id:7,a:[{n:"data",t:makeValue<Uint8Array>(MUint8Array)}]}]);
...
export let ClientApiSafe_META=makeApi<ClientApiSafe>([{n:"sendCloud",id:12,a:[{n:"uid",t:MUUID},{n:"cloud",t:common.Cloud_META}]},{n:"changeParent",id:4,a:[{n:"uid",t:MUUID}]},{n:"changeAlias",id:5,a:[{n:"alias",t:MUUID}]},{n:"sendMessage",id:10,a:[{n:"uid",t:MUUID},{n:"data",t:makeValue<Uint8Array>(MUint8Array)}]},{n:"sendServerDescriptor",id:11,a:[{n:"v",t:common.ServerDescriptor_META}]},{n:"newChild",id:6,a:[{n:"uid",t:MUUID}]}]);}
}
...
export let Key_META=makeObj<Key>({c:{"0":key.SodiumCurvePublic_META,"2":key.SodiumChacha20Poly1305_META,"6":key.HydrogenSignPrivate_META,"4":key.SodiumSignPrivate_META,"8":key.HydrogenCurvePrivate_META,"9":key.HydrogenSecretBox_META,"1":key.SodiumCurvePrivate_META,"3":key.SodiumSignPublic_META,"7":key.HydrogenCurvePublic_META,"5":key.HydrogenSignPublic_META}});
...
export let SodiumChacha20Poly1305_META=makeObj<key.SodiumChacha20Poly1305>({f:[{n:"data",t:makeSBytes(32)}]});

export class HydrogenSignPrivate extends Key{
data:Uint8Array;
}
export let HydrogenSignPrivate_META=makeObj<key.HydrogenSignPrivate>({f:[{n:"data",t:makeSBytes(64)}]});
...
export let HydrogenCurvePrivate_META=makeObj<key.HydrogenCurvePrivate>({f:[{n:"data",t:makeSBytes(32)}]});
...
export let HydrogenCurvePublic_META=makeObj<key.HydrogenCurvePublic>({f:[{n:"data",t:makeSBytes(32)}]});
